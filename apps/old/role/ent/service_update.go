...
func (su *ServiceUpdate) AddGroupIDs(ids ...uuid.UUID) *ServiceUpdate {
	su.mutation.AddGroupIDs(ids...)
	return su
}

// AddGroups adds the "groups" edges to the Group entity.
func (su *ServiceUpdate) AddGroups(g ...*Group) *ServiceUpdate {
...
func (su *ServiceUpdate) AddClientAccessIDs(ids ...uuid.UUID) *ServiceUpdate {
	su.mutation.AddClientAccessIDs(ids...)
	return su
}

// AddClientAccesses adds the "client_accesses" edges to the ClientAccess entity.
func (su *ServiceUpdate) AddClientAccesses(c ...*ClientAccess) *ServiceUpdate {
	ids := make([]uuid.UUID, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return su.AddClientAccessIDs(ids...)
}
...
func (su *ServiceUpdate) ClearGroups() *ServiceUpdate {
	su.mutation.ClearGroups()
	return su
}

// RemoveGroupIDs removes the "groups" edge to Group entities by IDs.
func (su *ServiceUpdate) RemoveGroupIDs(ids ...uuid.UUID) *ServiceUpdate {
	su.mutation.RemoveGroupIDs(ids...)
	return su
}

// RemoveGroups removes "groups" edges to Group entities.
func (su *ServiceUpdate) RemoveGroups(g ...*Group) *ServiceUpdate {
	ids := make([]uuid.UUID, len(g))
	for i := range g {
		ids[i] = g[i].ID
	}
...
// ClearClientAccesses clears all "client_accesses" edges to the ClientAccess entity.
func (su *ServiceUpdate) ClearClientAccesses() *ServiceUpdate {
	su.mutation.ClearClientAccesses()
	return su
}

// RemoveClientAccessIDs removes the "client_accesses" edge to ClientAccess entities by IDs.
func (su *ServiceUpdate) RemoveClientAccessIDs(ids ...uuid.UUID) *ServiceUpdate {
	su.mutation.RemoveClientAccessIDs(ids...)
	return su
}

// RemoveClientAccesses removes "client_accesses" edges to ClientAccess entities.
func (su *ServiceUpdate) RemoveClientAccesses(c ...*ClientAccess) *ServiceUpdate {
	ids := make([]uuid.UUID, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return su.RemoveClientAccessIDs(ids...)
}
...
func (su *ServiceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if su.mutation.ClientAccessesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := su.mutation.RemovedClientAccessesIDs(); len(nodes) > 0 && !su.mutation.ClientAccessesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.ClientAccessesTable,
	...
	if nodes := su.mutation.ClientAccessesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.ClientAccessesTable,
...
// AddGroupIDs adds the "groups" edge to the Group entity by IDs.
func (suo *ServiceUpdateOne) AddGroupIDs(ids ...uuid.UUID) *ServiceUpdateOne {
	suo.mutation.AddGroupIDs(ids...)
	return suo
}

// AddGroups adds the "groups" edges to the Group entity.
func (suo *ServiceUpdateOne) AddGroups(g ...*Group) *ServiceUpdateOne {
	ids := make([]uuid.UUID, len(g))
	for i := range g {
		ids[i] = g[i].ID
	}
...
// AddClientAccessIDs adds the "client_accesses" edge to the ClientAccess entity by IDs.
func (suo *ServiceUpdateOne) AddClientAccessIDs(ids ...uuid.UUID) *ServiceUpdateOne {
	suo.mutation.AddClientAccessIDs(ids...)
	return suo
}

// AddClientAccesses adds the "client_accesses" edges to the ClientAccess entity.
func (suo *ServiceUpdateOne) AddClientAccesses(c ...*ClientAccess) *ServiceUpdateOne {
	ids := make([]uuid.UUID, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return suo.AddClientAccessIDs(ids...)
}
...
// ClearGroups clears all "groups" edges to the Group entity.
func (suo *ServiceUpdateOne) ClearGroups() *ServiceUpdateOne {
	suo.mutation.ClearGroups()
	return suo
}

// RemoveGroupIDs removes the "groups" edge to Group entities by IDs.
func (suo *ServiceUpdateOne) RemoveGroupIDs(ids ...uuid.UUID) *ServiceUpdateOne {
	suo.mutation.RemoveGroupIDs(ids...)
	return suo
}

// RemoveGroups removes "groups" edges to Group entities.
func (suo *ServiceUpdateOne) RemoveGroups(g ...*Group) *ServiceUpdateOne {
	ids := make([]uuid.UUID, len(g))
	for i := range g {
		ids[i] = g[i].ID
	}
...
// ClearClientAccesses clears all "client_accesses" edges to the ClientAccess entity.
func (suo *ServiceUpdateOne) ClearClientAccesses() *ServiceUpdateOne {
	suo.mutation.ClearClientAccesses()
	return suo
}

// RemoveClientAccessIDs removes the "client_accesses" edge to ClientAccess entities by IDs.
func (suo *ServiceUpdateOne) RemoveClientAccessIDs(ids ...uuid.UUID) *ServiceUpdateOne {
	suo.mutation.RemoveClientAccessIDs(ids...)
	return suo
}

// RemoveClientAccesses removes "client_accesses" edges to ClientAccess entities.
func (suo *ServiceUpdateOne) RemoveClientAccesses(c ...*ClientAccess) *ServiceUpdateOne {
	ids := make([]uuid.UUID, len(c))
	for i := range c {
		ids[i] = c[i].ID
	}
	return suo.RemoveClientAccessIDs(ids...)
}
...
func (suo *ServiceUpdateOne) sqlSave(ctx context.Context) (_node *Service, err error) {
	...
	if suo.mutation.ClientAccessesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.ClientAccessesTable,
	...
	if nodes := suo.mutation.RemovedClientAccessesIDs(); len(nodes) > 0 && !suo.mutation.ClientAccessesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.ClientAccessesTable,
	...
	if nodes := suo.mutation.ClientAccessesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.ClientAccessesTable,
