...
func HasGroups() predicate.Service {
...
func HasGroupsWith(preds ...predicate.Group) predicate.Service {
	return predicate.Service(func(s *sql.Selector) {
		step := newGroupsStep()
...
// HasClientAccesses applies the HasEdge predicate on the "client_accesses" edge.
func HasClientAccesses() predicate.Service {
	return predicate.Service(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasClientAccessesWith applies the HasEdge predicate on the "client_accesses" edge with a given conditions (other predicates).
func HasClientAccessesWith(preds ...predicate.ClientAccess) predicate.Service {
	return predicate.Service(func(s *sql.Selector) {
		step := newClientAccessesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
