...
func ServiceID(v uuid.UUID) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldServiceID, v))
}
...
func ServiceIDEQ(v uuid.UUID) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldServiceID, v))
}

// ServiceIDNEQ applies the NEQ predicate on the "service_id" field.
func ServiceIDNEQ(v uuid.UUID) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldServiceID, v))
}

// ServiceIDIn applies the In predicate on the "service_id" field.
func ServiceIDIn(vs ...uuid.UUID) predicate.Group {
	return predicate.Group(sql.FieldIn(FieldServiceID, vs...))
}

// ServiceIDNotIn applies the NotIn predicate on the "service_id" field.
func ServiceIDNotIn(vs ...uuid.UUID) predicate.Group {
	return predicate.Group(sql.FieldNotIn(FieldServiceID, vs...))
}
...
func HasService() predicate.Group {
...
func HasServiceWith(preds ...predicate.Service) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := newServiceStep()
