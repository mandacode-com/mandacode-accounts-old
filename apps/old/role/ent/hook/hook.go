...
// The ClientAccessFunc type is an adapter to allow the use of ordinary
// function as ClientAccess mutator.
type ClientAccessFunc func(context.Context, *ent.ClientAccessMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ClientAccessFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ClientAccessMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ClientAccessMutation", m)
}
