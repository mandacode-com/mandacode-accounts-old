...
type User struct {
	...
	// SyncCode holds the value of the "sync_code" field.
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldSyncCode, user.FieldEmailVerificationCode:
...
func (u *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldEmailVerificationCode:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field email_verification_code", values[i])
			} else if value.Valid {
				u.EmailVerificationCode = value.String
			}
		default:
...
func (u *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("email_verification_code=")
	builder.WriteString(u.EmailVerificationCode)
	builder.WriteByte(')')
