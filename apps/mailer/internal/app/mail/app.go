...
func (m *mailApp) SendEmailVerificationMail(email string, link string) error {
	data := struct {
		Link string
	}{
		Link: link,
...
func NewMailApp(host string, port int, username, password, sender string, logger *zap.Logger) (MailApp, error) {
