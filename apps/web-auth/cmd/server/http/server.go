...
func NewHTTPServer(port int, logger *zap.Logger, auth_reg server.HTTPRegisterer, token_reg server.HTTPRegisterer, sessionStore sessions.Store) (*HTTPServer, error) {
	engine := gin.Default()
