...
type GroupUserApp interface {
	...
	//
	// Returns:
	//   - *model.GroupUser: The created group user entity.
	//   - error: An error if the group user could not be created.
	CreateGroupUser(userID uuid.UUID, groupID uuid.UUID) (*model.GroupUser, error)
	...
	//
	// Returns:
	//   - *model.GroupUser: The group user entity if found.
	//   - error: An error if the group user could not be found or another error occurred.
	GetGroupUser(userID uuid.UUID, groupID uuid.UUID) (*model.GroupUser, error)
	...
	//   - userID: The unique uuid of the user.
	// Returns:
	//   - []*model.GroupUser: A slice of group user entities associated with the user.
	//   - error: An error if the group users could not be retrieved.
	GetGroupUsersByUserID(userID uuid.UUID) ([]*model.GroupUser, error)
	...
	//
	// Returns:
	//   - []*model.GroupUser: A slice of group user entities associated with the group.
	GetGroupUsersByGroupID(groupID uuid.UUID) ([]*model.GroupUser, error)
